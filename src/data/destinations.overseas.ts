// SCR-001(`/`) 해외 여행지 정적 데이터(15개국 30개 도시 이상 — 현재 16개국 32곳).
...
export const overseasDestinations: OverseasDestination[] = [
  ...
  },
  {
    ...
    image: {
      ...
      credit: "사진: Jakub Hałun · CC BY 4.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "산악·전통",
    image: {
      url: "/images/places/chiangmai.jpg",
  ...
  },
  {
    ...
    theme: "항구·예술",
    image: {
      url: "/images/places/kaohsiung.jpg",
      alt: "가오슝 항구 야경과 조명 쇼",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:2021_Kaohsiung_harbor_Light_show.jpg",
      credit: "사진: Uming Photography · CC BY-SA 2.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "도시국가·정원",
    image: {
      url: "/images/places/singapore.jpg",
      ...
      credit: "사진: Diego Delso · CC BY-SA 4.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "유적·사원",
    image: {
      url: "/images/places/angkor.jpg",
      alt: "앙코르와트 일출 풍경",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Angkor_Wat_Sunrise_(209237385).jpeg",
      credit: "사진: Reinhard Onasch · CC BY-SA 3.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "역사·강변",
    image: {
      url: "/images/places/phnompenh.jpg",
      alt: "프놈펜 왕궁 즉위식장 전경",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Royal_Palace,_Phnom_Penh_Cambodia_1.jpg",
      credit: "사진: Hanay · CC BY-SA 3.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "르네상스·예술",
    image: {
      url: "/images/places/florence.jpg",
      ...
      credit: "사진: PROPOLI87 · CC BY-SA 4.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "미술관·왕궁",
    image: {
      url: "/images/places/madrid.jpg",
      alt: "마드리드 왕궁 전경",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Palacio_Real_de_Madrid_-_13.jpg",
      credit: "사진: Carlos Delgado · CC BY-SA 3.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    image: {
      ...
      credit: "사진: DXR · CC BY-SA 4.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "카페·골목",
    image: {
      url: "/images/places/melbourne.jpg",
      ...
      credit: "사진: -wuppertaler · CC BY 4.0 (Wikimedia Commons)",
    },
    summary:
  ...
  },
  {
    ...
    theme: "고대유적·사막",
    image: {
      url: "/images/places/cairo.jpg",
      alt: "카이로 근교 기자의 피라미드군",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:All_Gizah_Pyramids.jpg",
      credit: "사진: Ricardo Liberato · CC BY-SA 2.0 (Wikimedia Commons)",
    },
    summary:
      "카이로는 나일강을 따라 펼쳐진 이집트의 수도로, 시내에서 차로 30~40분이면 기자의 세 피라미드와 스핑크스 앞에 설 수 있는 세계적인 고대 문명 여행지입니다. 기자 고원 옆에 문을 연 이집트 대박물관에서는 투탕카멘 유물을 비롯한 방대한 소장품을 한자리에서 볼 수 있고, 이슬람 카이로 지구에서는 시타델과 무함마드 알리 모스크, 천 년 역사의 칸 엘 칼릴리 시장이 이어집니다. 콥트 카이로의 오래된 교회와 해 질 녘 나일강 펠루카(돛단배) 유람도 빼놓기 아쉬운 일정입니다. 한낮 더위와 교통 체증이 심하므로 유적 관람은 이른 아침에 시작하고, 시내 이동은 호출 앱 차량을 이용하면 한결 편합니다. 룩소르·아스완으로 이어지는 나일강 여행의 출발점으로 삼기에도 좋습니다.",
    highlights: [
      "기자 피라미드·스핑크스",
      "이집트 대박물관(GEM)",
      "칸 엘 칼릴리 시장",
    ...
    bestSeason: "가을~봄(10~4월, 선선한 건기)·겨울",
    oneDayItinerary: [
      "오전: 기자 피라미드·스핑크스(개장 직후 입장)",
      "점심: 기자 고원 인근 식당",
      "오후: 이집트 대박물관 관람",
      "저녁: 칸 엘 칼릴리 시장 산책과 저녁 식사",
    ],
    threeDayItinerary: [
      {
        day: 1,
        theme: "기자 고원",
        steps: ["기자 피라미드·스핑크스", "이집트 대박물관", "나일강 야경"],
      },
      {
        day: 2,
        theme: "이슬람·콥트 카이로",
      ...
      },
      {
        ...
        steps: [
          "사카라 계단식 피라미드",
          "멤피스 야외 박물관",
          "나일강 펠루카 유람 후 카이로국제공항 이동",
        ],
      },
    ],
    budget:
      "1인 3박 4일 기준 숙박·식비·교통·입장료 포함 약 60만~110만 원(항공료 별도).",
    transportation:
      "카이로국제공항에서 시내까지 호출 앱 차량·택시로 40~60분, 시내는 지하철과 호출 앱 차량을 이용합니다. 교통 체증이 심하고 운전 환경이 거칠어 직접 운전은 권하지 않습니다.",
    food: [
      "코샤리",
      "풀 메담스(콩 요리)",
      "타메야(이집트식 팔라펠)",
    ...
    etiquette: [
      "모스크에서는 신발을 벗고 어깨와 무릎을 가립니다(여성은 스카프 준비).",
      "사람·상점을 촬영할 때는 먼저 동의를 구하고, 군사 시설·검문소는 촬영하지 않습니다.",
      "낙타·마차 탑승과 안내 서비스는 타기 전에 요금을 정하고, 팁(박시시) 문화가 있음을 알아 둡니다.",
      "라마단 기간 낮에는 공공장소에서 음식·음료를 삼갑니다.",
    ],
    source: {
      name: "이집트 관광청(Experience Egypt)",
  ...
  },
  {
    ...
    theme: "해변·휴양",
    image: {
      url: "/images/places/hawaii.jpg",
      alt: "와이키키 해변에서 바라본 다이아몬드헤드",
      sourceUrl:
        "https://commons.wikimedia.org/wiki/File:Diamond_Head_from_Waikiki_Beach.jpg",
      credit: "사진: Jackie Gleason · Public domain (Wikimedia Commons)",
    },
    summary:
      "하와이 오아후섬은 호놀룰루 도심과 와이키키 해변, 화산 지형이 만든 절경을 한 섬에서 함께 즐길 수 있는 태평양의 대표 휴양지입니다. 와이키키에서는 초보자도 배우기 쉬운 잔잔한 파도에서 서핑을 체험할 수 있고, 다이아몬드헤드 분화구 트레일에 오르면 호놀룰루 해안선이 한눈에 들어옵니다. 하나우마 베이의 산호초 스노클링, 진주만 국립기념관, 겨울철 큰 파도로 유명한 노스쇼어와 할레이바 마을까지 하루 단위로 성격이 다른 일정을 짤 수 있습니다. 연중 온화하지만 자외선이 강하고 바다의 이안류 사고가 있으므로 안전요원이 있는 해변을 이용하는 것이 좋습니다. 렌터카를 빌리면 섬 일주 드라이브가 편하고, 와이키키 안에서는 도보와 버스만으로도 충분합니다.",
    highlights: [
      "와이키키 해변",
      "다이아몬드헤드 트레일",
      "하나우마 베이 스노클링",
    ...
    bestSeason: "봄(4~6월)·가을(9~10월), 연중 온화(겨울 노스쇼어는 큰 파도)",
    oneDayItinerary: [
      "오전: 다이아몬드헤드 트레일(사전 예약)",
      "점심: 와이키키 인근 포케·플레이트 런치",
      "오후: 와이키키 해변 서핑 또는 휴식",
      "저녁: 칼라카우아 거리 산책과 일몰 감상",
    ],
    threeDayItinerary: [
      {
        day: 1,
    ...
    budget:
      "1인 3박 4일 기준 숙박·식비·렌터카 포함 약 150만~250만 원(항공료 별도, 리조트 요금 별도 부과 확인).",
    transportation:
      "호놀룰루(대니얼 K. 이노우에) 국제공항에서 와이키키까지 셔틀·버스·택시로 30~40분, 섬 일주는 렌터카, 와이키키 안은 도보와 버스(TheBus)를 이용합니다.",
    food: ["포케", "로코모코", "갈릭 쉬림프", "셰이브 아이스"],
    etiquette: [
      "산호초를 밟거나 만지지 않고, 산호에 해로운 성분의 자외선 차단제는 사용하지 않습니다.",
      "바다거북·몽크물범 등 야생동물에는 다가가지 않고 거리를 둡니다.",
      "식당·택시 등에서는 15~20%의 팁이 관행입니다.",
      "사유지·출입 금지 트레일에는 들어가지 않습니다.",
    ],
    source: {
      name: "하와이 관광청(Go Hawaii)",
      url: "https://www.gohawaii.com/kr",
      updatedAt: "2026-09-19",
    },
  },
];
