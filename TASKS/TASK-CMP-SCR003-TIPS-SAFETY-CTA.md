---
task_id: CMP-SCR003-TIPS-SAFETY-CTA
type: component
screen_id: SCR-003
route: "`/travel-tools`"
page_entry: "`src/components/scr003/TipsSafetyCta.tsx`"
depends_on:
...
# CMP-SCR003-TIPS-SAFETY-CTA — 찾기 Tip 3개+안전 CTA

## Context
`CMP-SCR003-TIPS-SAFETY-CTA`(찾기 Tip 3개+안전 CTA)은 SCR-003(`/travel-tools`) 화면의 구현 Task다. `docs/06_SRS_UIUX_REVISED.md`가 정의한 Requirement와 `design-reference/UI_CONTRACT.md`가 정의한 화면 계약을 실제 개발 가능한 단위로 좁힌 것이며, 이 문서 자체는 계획서로서 구현 코드를 포함하지 않는다.
...
- Screen: SCR-003
- Route: `/travel-tools`
- Page Entry: `src/components/scr003/TipsSafetyCta.tsx`
...
## Test Cases
- TC-1(Functional): Tip 카드 정확히 3개, "동행 찾기로 이동" CTA
