...
# CMP-SCR002-HERO-STATS — 대표 Hero+수치 카드

## Context
`CMP-SCR002-HERO-STATS`(대표 Hero+수치 카드)은 SCR-002(`/about`) 화면의 구현 Task다. `docs/06_SRS_UIUX_REVISED.md`가 정의한 Requirement와 `design-reference/UI_CONTRACT.md`가 정의한 화면 계약을 실제 개발 가능한 단위로 좁힌 것이며, 이 문서 자체는 계획서로서 구현 코드를 포함하지 않는다.
...
- Screen: SCR-002
- Route: `/about`
- Page Entry: `src/components/scr002/HeroStats.tsx`
...
## Test Cases
- TC-1(Functional): `50+ Trips`/`30+ Countries` 카드 2개
- TC-2(Visual): Hero 55~65% 이내
